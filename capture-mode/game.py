...
class TicTacToe:
    ...
    def available_moves(self, player_letter):  # so '' or the other players letters
        return [i for (i, spot) in enumerate(self.board) if spot == ' ' or spot != player_letter]
    ...
    def make_move(self, square, letter):
        if self.board[square] == ' ' or self.board[square] != letter:
...
def play(game, x_player, o_player, print_game=True):
    ...
    while game.empty_squares():  # even though capture mode, still end when no empty square are there anymore
